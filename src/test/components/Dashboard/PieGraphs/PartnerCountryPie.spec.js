...
describe('components', () => {
  describe('PartnerCountryPie', () => {
    ...
    it('should render the footnote', () => {
      ...
      expect(footnote.text()).toBe('Source: U.S. Department of Commerce, Enforcement and Compliance using annual data from UN Comtrade, Desa/UNSD; YTD data from IHS Markit - Global Trade Atlas sourced from the reporting country\'s official statistics.  Trade covered in the table is 17,852,770.02 metric tons.');
    });
  });
});